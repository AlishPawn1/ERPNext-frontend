  ...
  return (
    <header className="bg-white shadow flex justify-between items-center px-6 py-3 sticky top-0 z-50">
      ...
      <div className="flex items-center space-x-4">
        ...
        <h1 className="text-lg font-medium text-gray-700">Buying</h1>{" "}
        {/* Page title */}
      </div>
      ...
      <div className="flex items-center space-x-4">
        ...
        {/* Profile dropdown */}
        <DropdownMenu>
          <DropdownMenuTrigger className="w-8 h-8 rounded-full bg-gray-200 flex items-center justify-center text-gray-700 font-semibold hover:bg-gray-300">
            A
          </DropdownMenuTrigger>
          <DropdownMenuContent>
